...
for profile,fits in fit_results.items():
    ...
    tau_BCZ_results_grid_bin_pdf = [ fits[i]['hist']['BCZ']['pdf'] for i in fits ]
    ...
    tau_HeII_results_grid_bin_pdf = [ fits[i]['hist']['HeII']['pdf'] for i in fits ]
    ...
    tau_H_results_grid_bin_pdf = [ fits[i]['hist']['H']['pdf'] for i in fits ]
